...
struct KVCacheSpec {
    ...
    std::string fingerprint() const {
        ...
        os << "tag=" << tag << ";type=" << static_cast<int>(type)
           << ";dtype=" << static_cast<int>(memoryLayoutDType())
           ...
           << ";v_block_payload_bytes=" << v_block_payload_bytes()
           << ";scale_block_bytes=" << scale_block_size_bytes()
