...
def rocm_oss_suites():
    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                name="rocm_qwen35_fp8_pd_tp2x2_cg_reuse_all",
                task_info="data/model/qwen35/qwen35_fp8_pd_tp2x2_cg_reuse_all.json",
                smoke_args={
                    "prefill": "--load_cache_timeout_ms 120000 --warm_up 0 --act_type BF16 --seq_size_per_block 1024 --kernel_seq_size_per_block 16 --max_seq_len 12800 --tp_size 2 --world_size 2 --ep_size 1 --use_asm_pa 1 --use_aiter_pa 1 --use_triton_pa 1 --reserver_runtime_mem_mb 10000 --quantization FP8_PER_CHANNEL_COMPRESSED --use_swizzleA 1 --reuse_cache 1 --cache_store_rdma_mode 0 --use_local 1 --role_type PREFILL",
                    "decode": "--load_cache_timeout_ms 120000 --warm_up 0 --act_type BF16 --seq_size_per_block 1024 --kernel_seq_size_per_block 16 --max_seq_len 12800 --tp_size 2 --world_size 2 --ep_size 1 --use_asm_pa 1 --use_aiter_pa 1 --use_triton_pa 1 --reserver_runtime_mem_mb 10000 --quantization FP8_PER_CHANNEL_COMPRESSED --use_swizzleA 1 --reuse_cache 1 --cache_store_rdma_mode 0 --use_local 1 --enable_cuda_graph 1 --enable_cuda_graph_debug_mode 1 --decode_capture_config '1,2,3,4' --role_type DECODE",
                },
                gpu_type=["MI308X-ROCM7"],
                data=native.glob(["data/model/qwen_vl/*.jpeg"]),
            ),
